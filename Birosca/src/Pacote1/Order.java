...
public class Order {
    ...
    public Order() {
        ...
        this.serviceFee = 0.1f;
        this.clientName = "";
    }

    public void addItem(Dish dish){
        this.consumedItems.add(dish);
    }

    public float calculateTotalItemsValue(){
        float sum = 0f;
    ...
    public float calculateServiceFee(){
        return calculateTotalItemsValue() * this.serviceFee;
    }

    public float calculateChange(){
        float change = 0f;
        Scanner input = new Scanner(System.in);
        System.out.println("Recebido em Dinheiro: ");
        float received = input.nextFloat();
